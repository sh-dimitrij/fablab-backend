...
urlpatterns = [
    ...
    path("add_work/<int:process_id>/", views.add_work, name='add_work'),
    path("count_works/", views.count_works, name='count_works'),
    path("cart/", views.count_works, name='cart'),
]