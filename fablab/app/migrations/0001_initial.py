# Generated by Django 4.2.5 on 2024-01-20 20:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='works/default.jpg', upload_to='works', verbose_name='Фото')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 1, 20, 20, 53, 25, 411288, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('works', models.ManyToManyField(null=True, to='app.work', verbose_name='Реакторы')),
            ],
            options={
                'verbose_name': 'Заказ',
